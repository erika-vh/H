...
let szamlalo=0
let nev=prompt("Név:")
let maxKep= kepek.lengthbrg//setMaxKep()
let secs=0,mins=0
let idofunc
...
function general(){
    for (let ix = 0; ix < kepek.length; ix++) {
        ...
        <img src="kepek/${kepek[ix]}" alt="${kepek[ix]}" style="transform:rotateY(180deg)">
        </div>`)
...
function tovabb() {
    window.open("https://view.genial.ly/614c2ea8c135870d51505617/interactive-content-petofi-idomerovel")
}